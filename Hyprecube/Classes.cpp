...
void Dianisma::set_cati(unsigned int x,int i){
  this->categ[i]=x;
}
...
void Dianisma::push_cat(unsigned int cat){
...
vector<unsigned int> Dianisma::get_cat(){
  return this->categ;
}
...
unsigned int Dianisma::get_cati(int i){
  return this->categ[i];
}
