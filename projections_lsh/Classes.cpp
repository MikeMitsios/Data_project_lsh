...
// void Dianisma::set_ai(int i,int j,int z,int val){
//   this->a[i][j][z]=val;
// }
...
// void Dianisma::push_a(int i,int j,int a){
...
// vector< vector<vector<int> > > Dianisma::get_a(){
//   return this->a;
// }
...
// int Dianisma::get_ai(int i,int j,int z){
//   return this->a[i][j][z];
// }
...
void Curves::set_hashing_dianisi(int i,int j,int  L,int  hash_categories){
  hashing(&(this->dianismata[i][j]), L, hash_categories);
}
...
lsh::lsh(int L,int K,int d,int W,int hash_categories){
